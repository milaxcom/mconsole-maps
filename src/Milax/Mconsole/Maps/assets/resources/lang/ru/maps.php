...
return [
    ...
    'acl' => [
        'index' => 'Карты: просмотр списка',
        'create' => 'Карты: форма создания',
        'store' => 'Карты: сохранение',
        'edit' => 'Карты: форма редактирования',
        'update' => 'Карты: обновление',
        'show' => 'Карты: просмотр',
        'destroy' => 'Карты: удаление',
    ],
];
